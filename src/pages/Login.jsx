    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4 relative">
      ...
      <div className="max-w-md w-full bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(30,58,138,0.1)] border border-slate-100 p-10">
        ...
        <form className="space-y-5">
          ...
          <button 
            type="submit" 
            className="w-full py-4 bg-primary text-white rounded-xl font-black text-sm tracking-widest hover:bg-primary-800 shadow-lg shadow-primary/20 transition-all active:scale-[0.98]"
          >
            MASUK KE SISTEM
          </button>
        </form>
